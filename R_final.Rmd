...
Los 50 transcritos identificados con mayor variabilidad en su expresión, como ESW23800 (varianza: 6.44) y ESW19553 (varianza: 3.96), sugieren ser blancos potenciales regulados por PvPHR-LIKE 7. Estos transcritos muestran diferencias significativas en su expresión entre los tratamientos (RNAi, Ox, EV) y estados de Pi (OPI, LPI), lo que apoya la hipótesis de que PvPHR-LIKE 7 desempeña un papel clave en la regulación de la respuesta al estré
